...
interface DocumentQuizComponentProps {
  questions: Question[]
  documentId: string
}
...
export default function DocumentQuizComponent({
  ...
  const handleSubmit = async () => {
    ...
    // Save quiz attempt (using document_questions table for now, could add document_quiz_attempts later)
    const supabase = createClient()
    // Note: We don't have a document_quiz_attempts table yet, so we'll skip saving for now
